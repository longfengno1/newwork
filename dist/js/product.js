...
/* harmony import */ var _index_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(220);
...
(function () {
  $(document).ready(function () {
    ...
    $(window).bind("scroll", function () {
      ...
      if (st > leftlistboxWrap_tag2.offset().top - 60 && st < leftlistboxWrap_tag2.offset().top + $("#tag2").next().height() - leftlistbox_tag2.height()) {
      ...
      if (st > leftlistboxWrap_tag3.offset().top - 60 && st < leftlistboxWrap_tag3.offset().top + $("#tag3").next().height() - leftlistbox_tag3.height()) {
